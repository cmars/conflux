...
// Package etcd provides a key-value storage implementation of the
...
func decode(s string) ([]byte, error) {
	r := base64.NewDecoder(base64.URLEncoding, strings.NewReader(s))
...
func (t *prefixTree) Create() (err error) {
	if t.client = etcd.NewClient(t.Settings.Machines()); err != nil {
		return
	}
	t.client.SetConsistency(etcd.STRONG_CONSISTENCY)
	return t.ensureRoot()
}
...
func (n *prefixNode) deleteNode() (err error) {
	_, err = n.client.Delete(encode(n.NodeKey), false)
	return
}
...
func (t *prefixTree) Insert(z *Zp) error {
	_, lookupErr := t.client.Get(encode(z.Bytes()), false, false)
	if lookupErr == nil {
	...
	_, err = t.client.Set(encode(z.Bytes()), "", 0)
	return err
}
...
func (t *prefixTree) Remove(z *Zp) error {
	...
	_, err = t.client.Delete(encode(z.Bytes()), false)
	return err
}
...
func (n *prefixNode) upsertNode() (err error) {
	...
	_, err = n.client.Set(encode(n.NodeKey), encode(buf.Bytes()), 0)
	return err
}
